...
#include "StarList.h"
/**
 * @brief Clase que representa un fantasma 1 en el juego.
 * Este fantasma es el fantasa de color rojo y se mueve ppersiguiendo al pacman o al poder usando el algoritmo A*.
 *
