...
#ifndef PROYECTO_2_DATOS_LL_GHOST4_H
#define PROYECTO_2_DATOS_LL_GHOST4_H
...
/**
 * @brief Clase que representa un fantasma 4 en el juego.
 * Este fantasma es el fantasa de color anaranjado y se mueve persiguiendo al pacman o al poder usando el algoritmo Backtracking.
 *
...
public:
     ...
     */
    Ghost4(int mapa[21][30],int j,int i);
    /**
...
* @return no retorna nada.
*/
    void actualizar_posicion_pacman4(int x, int y);
    /**
...
#endif //PROYECTO_2_DATOS_LL_GHOST4_H
