...
Ghost4::Ghost4(int mapa[21][30], int j, int i)

{
    setPixmap(QPixmap(":/Images/ghost4.png"));

    QTimer *timer_move = new QTimer;
    connect(timer_move, &QTimer::timeout, this, &Ghost4::move);
    ...
    position_x = j;//13
    position_y =i;//0 o 1
    std::cout << "Ghost4 inicial en matriz X: " << position_x<< std::endl;
    std::cout << "Ghost4 inicial en matriz Y: " << position_y<< std::endl;
...
void Ghost4::set_mapa(int mapa[21][30])
{
...
void Ghost4::chasePacMan() { //para calcular
...
void Ghost4::actualizar_posicion_pacman4(int x, int y) {
